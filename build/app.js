...
var _tryitResult = __webpack_require__(12);

var _tryitResult2 = _interopRequireDefault(_tryitResult);
  ...
  _createClass(TryItForm, [{
    ...
    value: function render() {
      ...
      return (0, _preact.h)(
        ...
        (0, _preact.h)(_tryitResult2.default, {
          url: this.state.url,
...
var TryItResult = function (_Component) {
  _inherits(TryItResult, _Component);

  function TryItResult() {
    _classCallCheck(this, TryItResult);

    var _this = _possibleConstructorReturn(this, (TryItResult.__proto__ || Object.getPrototypeOf(TryItResult)).call(this));

    _this.state = { url: "", visible: false, time: null };
    return _this;
  }

  _createClass(TryItResult, [{
    ...
    value: function render() {
      return (0, _preact.h)(
        "figure",
        { className: "qr-holder " + (this.state.visible ? "show" : "") },
        (0, _preact.h)("div", { id: "qr-target" }),
        (0, _preact.h)("figcaption", null)
      );
    }
  }]);
